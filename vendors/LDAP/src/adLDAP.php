...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@cantv.com.ve";
    ...
    * @var string
    */
	protected $baseDn = "ou=Usuarios,ou=Avanzados,ou=Cantv Users,ou=DATA,dc=cantv,dc=com,dc=ve"; 
    ...
    * @var array
    */
    protected $domainControllers = array("cantv.com.ve");
