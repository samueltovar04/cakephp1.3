 ...
 */
	function toString() {
     ...
     function separaCodigo($cel=NULL)
     {
         $cod[0]=substr($cel,0,4);
         $cod[1]=substr($cel,4,12);
         return $cod;
     }
     	function cambiar_num($num=null)
     	{
	  $letra=array('0'=>'Inicial','I','II','III','IV','V','VI','VII','VIII','IX','X','XI','XII');
	  return $letra[$num];

	 }
         function cambiarSexo($var=NULL)
         {
