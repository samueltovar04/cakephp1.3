		...
		if ($this->__active === true && $this->__start()) {
			if (parent::check('Message.' . $key)) {
				...
				if ($flash['element'] == 'default') {
					...
					$out = '<div id="' . $key . 'Message" class="' . $class . '">' . $flash['message'] . '</div><script type="text/javascript" language="javascript">
		 window.setTimeout("document.getElementById(\'' . $key . 'Message\').style.display=\'none\';",3000);
			  </script>';
